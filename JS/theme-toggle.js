document.addEventListener("DOMContentLoaded", () => {
    ...
    const toggleCustomizerButton = document.getElementById("toggle-customizer"); // New button
    ...
    // Toggle custom theme form visibility
    toggleCustomizerButton.addEventListener("click", () => {
        themeCustomizer.classList.toggle("visible");
    });
